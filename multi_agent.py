...
N_agents, N_sats = 3, 0
action_range = 3
p_move = 0.001  # weight of penalty of moving w.r.t. penalty of incorrect distribution estimate
...
if TRAIN:
    ...
    # Save the model
    torch.save(agent.model.state_dict(), 'models/dqn_multi_4agents.pt')

# Test DQN
agent.model.load_state_dict(torch.load('models/dqn_multi_4agents.pt'))
env.reset()
